...
class Configuration(AbjadConfiguration):
    ...
    def _path_to_storehouse_annotation(self, path):
        ...
        if score_path:
            ...
            manager = abjadide.idetools.ScorePackageManager(
                path=score_path,
                session=session,
                )
    ...
    def list_score_directories(
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     ):
                ...     x
                '.../abjadide/scores/blue_example_score'
                '.../abjadide/scores/etude_example_score'
                '.../abjadide/scores/red_example_score'
