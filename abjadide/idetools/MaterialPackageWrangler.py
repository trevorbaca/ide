...
from abjadide.idetools.ScoreInternalPackageWrangler import \
...
class MaterialPackageWrangler(ScoreInternalPackageWrangler):
    ...
    ..  container:: example
        ...
        ::
            ...
            >>> wrangler = abjadide.idetools.MaterialPackageWrangler(
            ...     session=session,
            ...     )
            >>> wrangler
    ...
    ..  container:: example
        ...
        ::
            ...
            >>> wrangler_in_score = abjadide.idetools.MaterialPackageWrangler(
            ...     session=session,
            ...     )
            >>> wrangler_in_score
            MaterialPackageWrangler()
    ...
    def _get_material_package_manager(self, class_name, path):
        ...
        command = 'manager = abjadide.idetools.{}'
