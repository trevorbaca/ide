...
from abjadide.idetools.PackageWrangler import PackageWrangler
...
class ScorePackageWrangler(PackageWrangler):
    ...
    ..  container:: example
        ...
        ::
            ...
            >>> wrangler = abjadide.idetools.ScorePackageWrangler(
            ...     session=session,
            ...     )
            >>> wrangler
    ...
    ..  container:: example
        ...
        ::
            ...
            >>> wrangler_in_score = abjadide.idetools.ScorePackageWrangler(
            ...     session=session,
            ...     )
            >>> wrangler_in_score
            ScorePackageWrangler()
