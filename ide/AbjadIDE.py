...
class AbjadIDE(object):
    ...
    def _copy_boilerplate(
        ...
        values = values or {}
        boilerplate = abjad.Path(abjad.abjad_configuration.boilerplate_directory)
    ...
    def edit_lilypond_log(self) -> None:
        ...
        Edits ``lily.log``.
        """
        path = abjad.Path(abjad.abjad_configuration.lilypond_log_file_path)
        self._open_files([path])
    ...
    def trash_back_cover_pdf(self, directory: abjad.Path) -> None:
        """
    ...
    def trash_back_cover_tex(self, directory: abjad.Path) -> None:
        """
    ...
    def trash_definition_py(self, directory: abjad.Path) -> None:
        """
    ...
    def trash_front_cover_pdf(self, directory: abjad.Path) -> None:
        """
    ...
    def trash_front_cover_tex(self, directory: abjad.Path) -> None:
        """
    ...
    def trash_illustration_ily(self, directory: abjad.Path) -> None:
        """
    ...
    def trash_illustration_ly(self, directory: abjad.Path) -> None:
        """
    ...
    def trash_illustration_pdf(self, directory: abjad.Path) -> None:
        """
    ...
    def trash_layout_ly(self, directory: abjad.Path) -> None:
        """
        Trashes ``layout.ly``.
        """
        assert directory.is_buildspace()
    ...
    def trash_layout_py(self, directory: abjad.Path) -> None:
        """
        Trashes ``layout.py``.
        """
        assert directory.is_buildspace()
    ...
    def trash_music_ly(self, directory: abjad.Path) -> None:
        """
        Trashes ``music.ly``.
        """
        assert directory.is__segments() or directory.is_build()
    ...
    def trash_music_pdf(self, directory: abjad.Path) -> None:
        """
        Trashes ``music.pdf``.
        """
        assert directory.is__segments() or directory.is_build()
    ...
    def trash_part_pdf(self, directory: abjad.Path) -> None:
        """
        Trashes ``part.pdf``.
        """
        assert directory.is_parts() or directory.is_part()
    ...
    def trash_part_tex(self, directory: abjad.Path) -> None:
        """
        Trashes ``part.tex``.
        """
        assert directory.is_parts() or directory.is_part()
    ...
    def trash_preface_pdf(self, directory: abjad.Path) -> None:
        """
        Trashes ``preface.pdf``.
        """
        assert directory.is__segments() or directory.is_build()
    ...
    def trash_preface_tex(self, directory: abjad.Path) -> None:
        """
        Trashes ``preface.tex``.
        """
        assert directory.is__segments() or directory.is_build()
    ...
    def trash_score_pdf(self, directory: abjad.Path) -> None:
        """
        Trashes ``score.pdf``.
        """
        assert directory.is__segments() or directory.is_build()
    ...
    def trash_score_tex(self, directory: abjad.Path) -> None:
        """
        Trashes ``score.tex``.
        """
        assert directory.is__segments() or directory.is_build()
    ...
    def trash_stylesheet_ily(self, directory: abjad.Path) -> None:
        """
