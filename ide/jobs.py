...
def color_clefs(path, undo=False) -> _segments.Job:
    name = "clef color"
...
def color_dynamics(path, undo=False) -> _segments.Job:
    name = "dynamic color"
...
def color_instruments(path, undo=False) -> _segments.Job:
    """
    Colors instruments.
    """
...
def color_margin_markup(path, undo=False) -> _segments.Job:
    """
...
def color_metronome_marks(path, undo=False) -> _segments.Job:
    """
...
def color_persistent_indicators(path, undo=False) -> _segments.Job:
    """
...
def color_staff_lines(path, undo=False) -> _segments.Job:
    """
    Colors staff lines.
    """
...
def color_time_signatures(path, undo=False) -> _segments.Job:
    """
...
def handle_edition_tags(path) -> _segments.Job:
    """
...
def handle_fermata_bar_lines(path) -> _segments.Job:
    """
...
def handle_mol_tags(path) -> _segments.Job:
    """
...
def handle_shifted_clefs(path) -> _segments.Job:
    """
...
def hide_default_clefs(path, undo=False) -> _segments.Job:
    """
    Hides default clefs.
    """
    name = "default clef"
...
def join_broken_spanners(path) -> _segments.Job:
    """
...
def show_music_annotations(path, undo=False) -> _segments.Job:
    """
