...
def test_AbjadIDE_build_score_pdf_01():
    ...
    with ide.Test():
        ...
        assert lines[index:] == [
            ...
            ' Found no other-document tags in letter-score ...',
            ' Found no this-document tags in letter-score ...',
            'Adjusting EOL fermata bar lines ...',
            ' Found no bar line adjustment tags in letter-score ...',
            ' Found no EOL fermata measure tags in letter-score ...',
            'Adjusting BOL shifted clefs ...',
            ' Found no shifted clef tags in letter-score ...',
            ' Found no BOL clef tags in letter-score ...',
