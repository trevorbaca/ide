...
def test_AbjadIDE_build_score_pdf_01():
    ...
    with ide.Test():
        ...
        assert lines[index:] == [
            ...
            'No + tags to deactivate in letter-score ...',
            'No -LETTER_SCORE tags to deactivate in letter-score ...',
            'No +LETTER_SCORE tags to activate in letter-score ...',
            'No BAR_LINE_ADJUSTMENT_AFTER_EOL_FERMATA tags to activate in letter-score ...',
            'No BAR_LINE_ADJUSTMENT_AFTER_EOL_FERMATA tags to deactivate in letter-score ...',
            'No SHIFTED_CLEF tags to activate in letter-score ...',
            'No SHIFTED_CLEF tags to deactivate in letter-score ...',
            'No persistent indicator color expression tags to deactivate in letter-score ...',
            'No persistent indicator color suppression tags to activate in letter-score ...',
            'No colored markup tags to deactivate in letter-score ...',
            '',
