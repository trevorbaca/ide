...
def test_AbjadIDE_deactivate_segment_empty_start_bar_01():
...
def test_AbjadIDE_deactivate_segment_empty_start_bar_02():

    abjad_ide('blu %let sesbx q')
    transcript = abjad_ide.io.transcript
