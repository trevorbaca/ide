...
def test_AbjadIDE_display_navigation_help_02():
    ...
    menu = abjad_ide.io.transcript.menus[-1]
    menu_ = [
        'Red Score (2017) : materials : magic_numbers : navigation',
        '',
        '    display navigation help (;)',
        '',
        '    go to library (lib)',
...
def test_AbjadIDE_display_navigation_help_03():
    ...
    menu = abjad_ide.io.transcript.menus[-1]
    menu_ = [
        'Red Score (2017) : materials : navigation',
        '',
        '    display navigation help (;)',
        '',
        '    go to library (lib)',
...
def test_AbjadIDE_display_navigation_help_06():
    ...
    menu = abjad_ide.io.transcript.menus[-1]
    menu_ = [
        'Red Score (2017) : segments : A : navigation',
        '',
        '    display navigation help (;)',
        '',
        '    go to library (lib)',
...
def test_AbjadIDE_display_navigation_help_07():
    ...
    menu = abjad_ide.io.transcript.menus[-1]
    menu_ = [
        'Red Score (2017) : segments : navigation',
        '',
        '    display navigation help (;)',
        '',
        '    go to library (lib)',
...
def test_AbjadIDE_display_navigation_help_08():
    ...
    menu = abjad_ide.io.transcript.menus[-1]
    menu_ = [
        'Red Score (2017) : stylesheets : navigation',
        '',
        '    display navigation help (;)',
        '',
        '    go to library (lib)',
