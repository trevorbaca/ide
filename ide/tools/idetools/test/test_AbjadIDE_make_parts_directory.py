...
def test_AbjadIDE_make_parts_directory_01():
    ...
    with ide.Test():
        ...
        for line in [
            ...
            'No -ARCH_A_PARTS* tags to deactivate ...',
            'No +ARCH_A_PARTS* tags to activate ...',
            'No BAR_LINE_ADJUSTMENT_AFTER_EOL_FERMATA tags to activate ...',
            'No SHIFTED_CLEF tags to activate ...',
            'Deactivating 26 persistent indicator color expression tags in segment-_.ly ...',
            'Activating 1 persistent indicator color suppression tag in segment-_.ly ...',
