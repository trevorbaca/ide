...
def test_AbjadIDE_new_01():
    ...
    with ide.Test(remove=[build]):
        ...
        assert lines[index:] == [
            ...
            ' Deactivating score annotation tags in arch-a-score ...',
            '  Found no score annotation tags in arch-a-score ...',
            'Joining broken spanners ...',
            ' Activating broken spanner expression tags in arch-a-score ...',
            '  Found no broken spanner expression tags in arch-a-score ...',
            ' Deactivating broken spanner suppression tags in arch-a-score ...',
...
def test_AbjadIDE_new_04():
    ...
    with ide.Test():
        ...
        for line in [
            ...
            'Uncoloring persistent indicators ...',
            ' Deactivating persistent indicator color expression tags in arch-a-parts ...',
            ...
            ' Activating persistent indicator color suppression tags in arch-a-parts ...',
            ...
            'Hiding score annotations ...',
            ' Deactivating score annotation tags in arch-a-parts ...',
