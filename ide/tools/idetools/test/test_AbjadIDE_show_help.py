...
def test_AbjadIDE_show_help_01():
    ...
    assert menu == [
        ...
        '    BUILD - hide (blx)',
        '    CLOCK-TIME - hide (ktx)',
        '    FIGURE-NAME - hide (fnx)',
        '    STAGE-NUMBER - hide (snx)',
        '',
        '    SEGMENT:BREAK (gk)',
        '    SEGMENT:DUPLICATE (gd)',
        '    SEGMENT:EMPTY-BAR (geb)',
        '    SEGMENT:FERMATA-MEASURE-TREATMENT (gfm)',
        '    SEGMENT:REMINDER (gr)',
        '    SEGMENT:SPACING:COMMAND (gsc)',
        '    SEGMENT:SPACING:MARKUP (gsm)',
        '',
        '    SEGMENT:BREAK - hide (gkx)',
        '    SEGMENT:DUPLICATE - hide (gdx)',
        '    SEGMENT:EMPTY-BAR - hide (gebx)',
        '    SEGMENT:FERMATA-MEASURE-TREATMENT - hide (gfmx)',
        '    SEGMENT:REMINDER - hide (grx)',
        '    SEGMENT:SPACING:COMMAND - hide (gscx)',
        '    SEGMENT:SPACING:MARKUP - hide (gsmx)',
        '',
        ]
