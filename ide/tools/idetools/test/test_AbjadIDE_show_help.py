...
def test_AbjadIDE_show_help_01():
    ...
    assert menu == [
        ...
        '',
        '    CLOCK_TIME - hide (ctx)',
        '    FIGURE_NAME - hide (fnx)',
        '    STAGE_NUMBER - hide (snx)',
        '',
        ...
        '',
        '    SEGMENT:DUPLICATE (gd)',
        '    SEGMENT:EMPTY_START_BAR (gesb)',
        '    SEGMENT:FERMATA_BAR_LINE (gfbl)',
        '    SEGMENT:LAYOUT (gl)',
        '    SEGMENT:REMINDER (gr)',
        '    SEGMENT:SPACING_COMMAND (gsc)',
        '    SEGMENT:SPACING_MARKUP (gsm)',
        '',
        '    SEGMENT:DUPLICATE - hide (gdx)',
        '    SEGMENT:EMPTY_START_BAR - hide (gesbx)',
        '    SEGMENT:FERMATA_BAR_LINE - hide (gfblx)',
        '    SEGMENT:LAYOUT - hide (glx)',
        '    SEGMENT:REMINDER - hide (grx)',
        '    SEGMENT:SPACING_COMMAND - hide (gscx)',
        '    SEGMENT:SPACING_MARKUP - hide (gsmx)',
        '',
        ]
