...
def test_AbjadIDE_show_help_01():
    ...
    assert menu == [
        ...
        '    SEGMENT:DUPLICATEx (gdx)',
        '    SEGMENT:EMPTY-BAR (geb)',
        '    SEGMENT:EMPTY-BARx (gebx)',
        '    SEGMENT:FERMATA-MEASURE-TREATMENT (gfm)',
        '    SEGMENT:FERMATA-MEASURE-TREATMENTx (gfmx)',
        '    SEGMENT:REMINDER (gr)',
        '    SEGMENT:REMINDERx (grx)',
        '    SEGMENT:SPACING:COMMAND (gsc)',
        '    SEGMENT:SPACING:COMMANDx (gscx)',
        '    SEGMENT:SPACING:MARKUP (gsm)',
        '    SEGMENT:SPACING:MARKUPx (gsmx)',
        '    STAGE-NUMBER (sn)',
        '    STAGE-NUMBERx (snx)',
        '',
        '    text - edit (it)',
