...
def test_AbjadIDE_show_help_08():
    ...
    assert menu == [
        ...
        '    clipboard - show (cs)',
        '',
        '    definition.py - check (dfk)',
        '    definition.py - edit (dfe)',
        '    definition.py - trash (dft)',
        '',
        '    git - commit (ci)',
        '    git - diff (diff)',
        '    git - pull (pull)',
        ...
        '    hop - previous score (<<)',
        '',
        '    illustration.ly - edit (lye)',
        '    illustration.ly - interpret (lyi)',
        '    illustration.ly - make (lym)',
        '    illustration.ly - trash (lyt)',
        '',
        '    illustration.pdf - make (pdfm)',
        '    illustration.pdf - nake (pdfn)',
        '    illustration.pdf - open (pdfo)',
        '    illustration.pdf - trash (pdft)',
        '',
        '    log - aliases (al)',
        '    log - latex (lx)',
        '    log - lilypond (lp)',
...
def test_AbjadIDE_show_help_09():
    ...
    assert menu == [
        ...
        '    clipboard - show (cs)',
        '',
        '    definition.pys - check (dfk*)',
        '    definition.pys - edit (dfe*)',
        '    definition.pys - trash (dft*)',
        '',
        '    git - commit (ci)',
        '    git - diff (diff)',
        '    git - pull (pull)',
        ...
        '    hop - previous score (<<)',
        '',
        '    illustration.lys - interpret (lyi*)',
        '    illustration.lys - make (lym*)',
        '    illustration.lys - trash (lyt*)',
        '',
        '    illustration.pdfs - make (pdfm*)',
        '    illustration.pdfs - trash (pdft*)',
        '',
        '    log - aliases (al)',
        '    log - latex (lx)',
        '    log - lilypond (lp)',
