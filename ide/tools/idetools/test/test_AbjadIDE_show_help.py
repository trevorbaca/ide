...
def test_AbjadIDE_show_help_01():
    ...
    assert menu == [
        ...
        '    DYNAMICS - color (dcc)',
        '    INSTRUMENTS - b&w (ibw)',
        '    INSTRUMENTS - color (icc)',
        '    MARGIN MARKUP - b&w (ggbw)',
        '    MARGIN MARKUP - color (ggcc)',
        '    METRONOME MARKS - b&w (mmbw)',
        '    METRONOME MARKS - color (mmcc)',
        '    STAFF LINES - b&w (slbw)',
        '    STAFF LINES - color (slcc)',
        '    TIME SIGNATURES - b&w (tsbw)',
        '    TIME SIGNATURES - color (tscc)',
        '',
