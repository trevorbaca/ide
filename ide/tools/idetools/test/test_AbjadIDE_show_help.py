...
def test_AbjadIDE_show_help_01():
    ...
    assert menu == [
        ...
        '    log - lilypond (lp)',
        '',
        '    lys - breaks - activate (lyb*)',
        '    lys - breaks - deactivate (lybb*)',
        '    lys - collect (lyc*)',
        '    lys - duplicates - activate (lyd*)',
        '    lys - duplicates - deactivate (lydd*)',
        '    lys - empty bars - activate (lye*)',
        '    lys - empty bars - deactivate (lyee*)',
        '    lys - fermata measure treatments - activate (lyf*)',
        '    lys - fermata measure treatments - deactivate (lyff*)',
        '    lys - reminders - activate (lyr*)',
        '    lys - reminders - deactivate (lyrr*)',
        '',
        '    music - edit (me)',
        '    music - generate (mg)',
        '    music - interpret (mi)',
