...
def test_MaterialPackageWrangler_version_every_package_01():
    ...
    can version. This is the reason for both the 'Nothing to version ...' and
    the 'Will copy ...' messages showing up in the transcript.

    Test test differs from the corresponding test for SegmentPackageWrangler.
    The reason is that the artifact structure of the material packages is more
    complicated. So this test doesn't both actually touching the filesystem and
    just test messaging.
    '''
