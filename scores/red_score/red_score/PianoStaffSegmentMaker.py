...
class PianoStaffSegmentMaker(abjad.SegmentMaker):
    """
    ...
    def __init__(
        ...
        abjad.SegmentMaker.__init__(self)
        time_signatures = time_signatures or []
        time_signatures = [abjad.TimeSignature(_) for _ in time_signatures]
        self._time_signatures = time_signatures
        self._divisions = divisions
        if rh_rhythm_maker is None:
            rh_rhythm_maker = abjadext.rmakers.NoteRhythmMaker()
        assert isinstance(rh_rhythm_maker, abjadext.rmakers.RhythmMaker)
        self._rh_rhythm_maker = rh_rhythm_maker
        if lh_rhythm_maker is None:
            lh_rhythm_maker = abjadext.rmakers.NoteRhythmMaker()
        assert isinstance(lh_rhythm_maker, abjadext.rmakers.RhythmMaker)
    ...
    def _make_lilypond_file(self, midi=None):
        ...
        lilypond_file = abjad.LilyPondFile(
            items=[block], includes=[stylesheet_path], use_relative_includes=True
        )
